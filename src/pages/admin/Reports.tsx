...
import {
  ...
  getOpenPlayReportSummary,
  type OpenPlayReportSummary,
  type ReportRow,
...
export default function Reports() {
  ...
  const [openPlaySummary, setOpenPlaySummary] =
    useState<OpenPlayReportSummary>({
      sessions: 0,
      participants: 0,
  ...
  return (
    <main className="pr-page">
      ...
      <section className="pr-card mt-6 p-5 sm:p-6">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-muted">
              Activity for the selected report period.
            </p>
          </div>
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          {[
            ['Sessions', openPlaySummary.sessions],
            ['Participants', openPlaySummary.participants],
            ['Confirmed', openPlaySummary.confirmedParticipants],
            ['Pending', openPlaySummary.pendingParticipants],
            ['Revenue', formatCurrency(openPlaySummary.revenue)],
          ].map(([label, value]) => (
