...
function getNotificationIcon(
  ...
  switch (type) {
    ...
    case 'open_play_joined':
      return '👥'

    case 'open_play_payment_submitted':
      return '₱'

    case 'open_play_payment_verified':
      return '✓'

    case 'open_play_payment_rejected':
      return '×'

    case 'open_play_cancelled':
    case 'open_play_session_cancelled':
      return '✕'
...
export default function NotificationBell({
  ...
  function navigateFromNotification(
    ...
    switch (
      ...
      case 'open_play_joined':
      case 'open_play_payment_submitted':
        navigate(isAdminRoute ? '/admin/open-play' : '/my-open-play')
        break
